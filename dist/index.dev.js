...
function () {
  ...
  _createClass(App, [{
    ...
    value: function initializeRoutes() {
      ...
      this.app.post('/biller-by-category', this.getCategoryBillers.bind(this));
      ...
      this.app.post('/keyPair', this.iswInstance.generateRSAKeyPair.bind(this.iswInstance));
    }
  }, {
    key: "accountBalance",
    value: function accountBalance(req, res) {
      var responseData;
      return regeneratorRuntime.async(function accountBalance$(_context) {
        while (1) {
    ...
    value: function transStatus(req, res) {
      var responseData;
      return regeneratorRuntime.async(function transStatus$(_context2) {
        while (1) {
    ...
    value: function validateCustomer(req, res) {
      var responseData;
      return regeneratorRuntime.async(function validateCustomer$(_context3) {
        while (1) {
    ...
    value: function getBillerCategories(req, res) {
      var responseData;
      return regeneratorRuntime.async(function getBillerCategories$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return regeneratorRuntime.awrap(this.iswInstance.getBillerCategories(req.body));
    ...
    value: function getCategoryBillers(req, res) {
      var responseData;
      return regeneratorRuntime.async(function getCategoryBillers$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return regeneratorRuntime.awrap(this.iswInstance.getCategoryBillers(req.body));
    ...
    value: function getPaymentItems(req, res) {
      var responseData;
      return regeneratorRuntime.async(function getPaymentItems$(_context6) {
        while (1) {
    ...
    value: function payment(req, res) {
      var responseData;
      return regeneratorRuntime.async(function payment$(_context7) {
        while (1) {
